...
export default function TripsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-cyan-400 to-teal-300 p-4 text-gray-800 transition-all duration-300">
      <div className="max-w-8xl mx-auto bg-white shadow-2xl rounded-xl p-2 space-y-6">
          ...
          <table className="w-full table-auto border-collapse shadow-sm rounded-md">
            <thead className="bg-blue-100 text-blue-800">
              <tr>
                ...
                <th className="p-2">Fleet Manager</th>
                <th className="p-2">Vehicle</th>
                <th className="p-2">Origin</th>
                <th className="p-2">Destination</th>
                <th className="p-2">Submission Date</th>
                <th className="p-2">Trip Start</th>
                <th className="p-2">Trip End</th>
            ...
            <tbody>
              {paginatedTrips.map((trip) => (
                ...
                >
                  ...
                  <td className="p-2">
                    {new Date(trip.submissionDate).toLocaleString()}
                  </td>
                  <td className="p-2">
                  ...
                  <td className="p-2">
                    <span
                      className={`px-3 py-1 rounded-full text-sm text-white ${
                        getStatus(trip.tripEndTime) === "Upcoming"
                          ? "bg-yellow-500"
                          : "bg-green-600"
                      }`}
                    >
                      {getStatus(trip.tripEndTime)}
                    </span>
                  </td>
